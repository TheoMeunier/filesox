...
export function SidebarMenuItem({
  ...
  return (
    <>
      <li
        className={`${isActive}  pr-2 py-2 text-sm hover:text-indigo-700 border-l-4  hover:border-indigo-700 hover:bg-indigo-50`}
      >
        {href === undefined ? (
          <button className="flex items-center gap-2 pl-3" onClick={onClick}>
