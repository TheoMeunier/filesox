  ...
  const getAvailableOptions = () => {
    ...
    if (isMultiple && Array.isArray(normalizedValue)) {
      availableOptions = options.filter(
        (option) => !normalizedValue.includes(option.value)
      );
    } else if (
      !isMultiple &&
              ...
              <div className="px-4 py-8 text-center text-gray-500">
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M9.172 16.172a4 4 0 015.656 0M9 12h6m-6-4h6m2 5.291A7.962 7.962 0 0112 20a7.962 7.962 0 01-5-1.709M15 3H9a2 2 0 00-2 2v1.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 000 1.414l6.414 6.414A1 1 0 008 21.414V21a2 2 0 002 2h6a2 2 0 002-2v-.586a1 1 0 01.293-.707l6.414-6.414a1 1 0 000-1.414L18.293 7.293A1 1 0 0018 6.586V5a2 2 0 00-2-2z"
                  />
                </svg>
                {noOptionsMessage}
              </div>
