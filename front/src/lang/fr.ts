  ...
  translation: {
    ...
    input: {
      ...
      placeholder: {
        ...
        permissions: 'Selectionner les permissions pour cet utilisateur',
      },
      options: {
        shares: {
          hours: 'Heures',
      ...
      description: {
        move_storage:
          'Si vous voulez déplacer le dossier à la racine remplicer le champs',
        create_user:
          "Si vous souhaitez que l'utilisateur est l'espace de stockage racine, remplisser le champs",
