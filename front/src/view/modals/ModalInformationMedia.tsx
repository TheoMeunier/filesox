        ...
        <dl className="text-gray-900 divide-y divide-gray-200">
          {activeStorage && 'id' in activeStorage && (
            <div className="flex flex-col py-3">
              <dt className="mb-1 text-indigo-500">{t('input.label.id')}:</dt>
              <dd className="mb-1 text-gray-500">{activeStorage.id}</dd>
            </div>
          )}
          {activeStorage && 'path' in activeStorage && (
            <div className="flex flex-col py-3">
              <dt className="mb-1 text-indigo-500">{t('input.label.path')}:</dt>
              <dd className="mb-1 text-gray-500 break-words whitespace-normal">
                {activeStorage.path}
              </dd>
            </div>
          )}
          {activeStorage && 'name' in activeStorage && (
            <div className="flex flex-col py-3">
              <dt className="mb-1 text-indigo-500">{t('input.label.name')}:</dt>
              <dd className="mb-1 text-gray-500 break-words whitespace-normal">
                {activeStorage.name}
              </dd>
            </div>
          ...
          {activeStorage && 'size' in activeStorage && (
            <div className="flex flex-col pt-3">
              <dt className="mb-1 text-indigo-500">{t('input.label.size')}:</dt>
