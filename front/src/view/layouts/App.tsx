                ...
                {location.pathname === '/' && activeStorage && (
                  <>
                    ...
                    {role([RoleEnum.EDIT_OBJECT], user!.roles) && (
                      <ButtonIcon
                        svg={MoveUpRight}
                        title={t('tooltip.move')}
                        onClick={() =>
                          openModal(() => <ModalMoveMedia />, 'md')
                        }
                      />
                    )}
                    ...
                    <ButtonIcon
                      ...
                      onClick={() =>
                        openModal(() => <ModalInformationMedia />, 'lg')
                      }
                    />
                    <ButtonDownload />
                  </>
        ...
        <Sidebar sidebarOpen={sidebarOpen} setter={setSidebarOpen}>
          <SidebarMenuContent>
            <SidebarMenu>
              ...
              <SidebarMenuItem href="/" active="/" svg={Home}>
                {t('title.nav.dashboard')}
              </SidebarMenuItem>
