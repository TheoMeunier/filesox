...
export const useImageGalleryStore = create<State & Action>((set) => ({
  ...
  setImageGalleryIndex: (imageGalleryIndex: number) =>
    set({ imageGalleryIndex }),
  setImageGallery: (showImageGallery: boolean, imageGalleryIndex: number) =>
    set({ showImageGallery, imageGalleryIndex }),
}));
